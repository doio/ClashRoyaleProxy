...
namespace ClashRoyaleProxy
{
	/*
	 * @description 
	 *   TweetNacl.c C# porting
	 * */
	public sealed class TweetNaclFast
	{

		private const string TAG = "TweetNaclFast";
...
//ORIGINAL LINE: public byte [] box(byte [] message, final int moff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] box(byte [] message, final int moff, final int mlen)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] box(byte [] message, final int moff, byte [] theNonce)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] box(byte [] message, final int moff, final int mlen, byte [] theNonce)
			public byte [] box(byte[] message, int moff, int mlen, byte[] theNonce)
			{
				if (!(message != null && message.Length >= (moff + mlen) && theNonce != null && theNonce.Length == nonceLength))
				{
				  return null;
				}
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] open(byte [] box, final int boxoff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] open(byte [] box, final int boxoff, final int boxlen)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] open(byte [] box, final int boxoff, byte [] theNonce)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] open(byte [] box, final int boxoff, final int boxlen, byte [] theNonce)
			 ...
			 * */
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] after(byte [] message, final int moff, final int mlen)
			 ...
			 * */
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] after(byte [] message, final int moff, final int mlen, byte [] theNonce)
			 ...
			 * */
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] open_after(byte [] box, final int boxoff, final int boxlen)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] open_after(byte [] box, final int boxoff, final int boxlen, byte [] theNonce)
...
//ORIGINAL LINE: public byte [] open(byte [] box, final int boxoff, final int boxlen, byte [] theNonce)
			...
			{
				// check message
				if (!(box != null && box.Length >= (boxoff + boxlen) && boxlen >= boxzerobytesLength && theNonce != null && theNonce.Length == nonceLength))
				{
					return null;
				}
                ...
                crypto_secretbox_open(m, c, c.Length, theNonce, key);
...
//ORIGINAL LINE: public static byte[] sha512(String message) throws java.io.UnsupportedEncodingException
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] sign(byte [] message, final int moff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] sign(byte [] message, final int moff, final int mlen)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] open(byte [] signedMessage, final int smoff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public byte [] open(byte [] signedMessage, final int smoff, final int smlen)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static void ts64(byte [] x, final int xoff, long u)
		private static void ts64(byte[] x, int xoff, long u)
		{
			///int i;
			///for (i = 7;i >= 0;--i) { x[i+xoff] = (byte)(u&0xff); u >>>= 8; }

			x[7 + xoff] = unchecked((byte)(u & 0xff));
			u = (long)((ulong)u >> 8);
			x[6 + xoff] = unchecked((byte)(u & 0xff));
			u = (long)((ulong)u >> 8);
			x[5 + xoff] = unchecked((byte)(u & 0xff));
			u = (long)((ulong)u >> 8);
			x[4 + xoff] = unchecked((byte)(u & 0xff));
			u = (long)((ulong)u >> 8);
			x[3 + xoff] = unchecked((byte)(u & 0xff));
			u = (long)((ulong)u >> 8);
			x[2 + xoff] = unchecked((byte)(u & 0xff));
			u = (long)((ulong)u >> 8);
			x[1 + xoff] = unchecked((byte)(u & 0xff));
			u = (long)((ulong)u >> 8);
			x[0 + xoff] = unchecked((byte)(u & 0xff)); ///u >>>= 8;
		}

//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static int vn(byte [] x, final int xoff, byte [] y, final int yoff, int n)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static int crypto_verify_16(byte [] x, final int xoff, byte [] y, final int yoff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static int crypto_verify_32(byte [] x, final int xoff, byte [] y, final int yoff)
		...
		{
			int j0 = c[0] & 0xff | (c[1] & 0xff) << 8 | (c[2] & 0xff) << 16 | (c[3] & 0xff) << 24, j1 = k[0] & 0xff | (k[1] & 0xff) << 8 | (k[2] & 0xff) << 16 | (k[3] & 0xff) << 24, j2 = k[4] & 0xff | (k[5] & 0xff) << 8 | (k[6] & 0xff) << 16 | (k[7] & 0xff) << 24, j3 = k[8] & 0xff | (k[9] & 0xff) << 8 | (k[10] & 0xff) << 16 | (k[11] & 0xff) << 24, j4 = k[12] & 0xff | (k[13] & 0xff) << 8 | (k[14] & 0xff) << 16 | (k[15] & 0xff) << 24, j5 = c[4] & 0xff | (c[5] & 0xff) << 8 | (c[6] & 0xff) << 16 | (c[7] & 0xff) << 24, j6 = p[0] & 0xff | (p[1] & 0xff) << 8 | (p[2] & 0xff) << 16 | (p[3] & 0xff) << 24, j7 = p[4] & 0xff | (p[5] & 0xff) << 8 | (p[6] & 0xff) << 16 | (p[7] & 0xff) << 24, j8 = p[8] & 0xff | (p[9] & 0xff) << 8 | (p[10] & 0xff) << 16 | (p[11] & 0xff) << 24, j9 = p[12] & 0xff | (p[13] & 0xff) << 8 | (p[14] & 0xff) << 16 | (p[15] & 0xff) << 24, j10 = c[8] & 0xff | (c[9] & 0xff) << 8 | (c[10] & 0xff) << 16 | (c[11] & 0xff) << 24, j11 = k[16] & 0xff | (k[17] & 0xff) << 8 | (k[18] & 0xff) << 16 | (k[19] & 0xff) << 24, j12 = k[20] & 0xff | (k[21] & 0xff) << 8 | (k[22] & 0xff) << 16 | (k[23] & 0xff) << 24, j13 = k[24] & 0xff | (k[25] & 0xff) << 8 | (k[26] & 0xff) << 16 | (k[27] & 0xff) << 24, j14 = k[28] & 0xff | (k[29] & 0xff) << 8 | (k[30] & 0xff) << 16 | (k[31] & 0xff) << 24, j15 = c[12] & 0xff | (c[13] & 0xff) << 8 | (c[14] & 0xff) << 16 | (c[15] & 0xff) << 24;
			...
			{
				u = x0 + x12 | 0;
				x4 ^= u << 7 | (int)((uint)u>>(32 - 7));
				u = x4 + x0 | 0;
				x8 ^= u << 9 | (int)((uint)u>>(32 - 9));
				u = x8 + x4 | 0;
				x12 ^= u << 13 | (int)((uint)u>>(32 - 13));
				u = x12 + x8 | 0;
				x0 ^= u << 18 | (int)((uint)u>>(32 - 18));

				u = x5 + x1 | 0;
				x9 ^= u << 7 | (int)((uint)u>>(32 - 7));
				u = x9 + x5 | 0;
				x13 ^= u << 9 | (int)((uint)u>>(32 - 9));
				u = x13 + x9 | 0;
				x1 ^= u << 13 | (int)((uint)u>>(32 - 13));
				u = x1 + x13 | 0;
				x5 ^= u << 18 | (int)((uint)u>>(32 - 18));

				u = x10 + x6 | 0;
				x14 ^= u << 7 | (int)((uint)u>>(32 - 7));
				u = x14 + x10 | 0;
				x2 ^= u << 9 | (int)((uint)u>>(32 - 9));
				u = x2 + x14 | 0;
				x6 ^= u << 13 | (int)((uint)u>>(32 - 13));
				u = x6 + x2 | 0;
				x10 ^= u << 18 | (int)((uint)u>>(32 - 18));

				u = x15 + x11 | 0;
				x3 ^= u << 7 | (int)((uint)u>>(32 - 7));
				u = x3 + x15 | 0;
				x7 ^= u << 9 | (int)((uint)u>>(32 - 9));
				u = x7 + x3 | 0;
				x11 ^= u << 13 | (int)((uint)u>>(32 - 13));
				u = x11 + x7 | 0;
				x15 ^= u << 18 | (int)((uint)u>>(32 - 18));

				u = x0 + x3 | 0;
				x1 ^= u << 7 | (int)((uint)u>>(32 - 7));
				u = x1 + x0 | 0;
				x2 ^= u << 9 | (int)((uint)u>>(32 - 9));
				u = x2 + x1 | 0;
				x3 ^= u << 13 | (int)((uint)u>>(32 - 13));
				u = x3 + x2 | 0;
				x0 ^= u << 18 | (int)((uint)u>>(32 - 18));

				u = x5 + x4 | 0;
				x6 ^= u << 7 | (int)((uint)u>>(32 - 7));
				u = x6 + x5 | 0;
				x7 ^= u << 9 | (int)((uint)u>>(32 - 9));
				u = x7 + x6 | 0;
				x4 ^= u << 13 | (int)((uint)u>>(32 - 13));
				u = x4 + x7 | 0;
				x5 ^= u << 18 | (int)((uint)u>>(32 - 18));

				u = x10 + x9 | 0;
				x11 ^= u << 7 | (int)((uint)u>>(32 - 7));
				u = x11 + x10 | 0;
				x8 ^= u << 9 | (int)((uint)u>>(32 - 9));
				u = x8 + x11 | 0;
				x9 ^= u << 13 | (int)((uint)u>>(32 - 13));
				u = x9 + x8 | 0;
				x10 ^= u << 18 | (int)((uint)u>>(32 - 18));

				u = x15 + x14 | 0;
				x12 ^= u << 7 | (int)((uint)u>>(32 - 7));
				u = x12 + x15 | 0;
				x13 ^= u << 9 | (int)((uint)u>>(32 - 9));
				u = x13 + x12 | 0;
				x14 ^= u << 13 | (int)((uint)u>>(32 - 13));
				u = x14 + x13 | 0;
				x15 ^= u << 18 | (int)((uint)u>>(32 - 18));
			}
			x0 = x0 + j0 | 0;
			...
			o[0] = unchecked((byte)((int)((uint)x0 >> 0) & 0xff));
			o[1] = unchecked((byte)((int)((uint)x0 >> 8) & 0xff));
			o[2] = unchecked((byte)((int)((uint)x0 >> 16) & 0xff));
			o[3] = unchecked((byte)((int)((uint)x0 >> 24) & 0xff));

			o[4] = unchecked((byte)((int)((uint)x1 >> 0) & 0xff));
			o[5] = unchecked((byte)((int)((uint)x1 >> 8) & 0xff));
			o[6] = unchecked((byte)((int)((uint)x1 >> 16) & 0xff));
			o[7] = unchecked((byte)((int)((uint)x1 >> 24) & 0xff));

			o[8] = unchecked((byte)((int)((uint)x2 >> 0) & 0xff));
			o[9] = unchecked((byte)((int)((uint)x2 >> 8) & 0xff));
			o[10] = unchecked((byte)((int)((uint)x2 >> 16) & 0xff));
			o[11] = unchecked((byte)((int)((uint)x2 >> 24) & 0xff));

			o[12] = unchecked((byte)((int)((uint)x3 >> 0) & 0xff));
			o[13] = unchecked((byte)((int)((uint)x3 >> 8) & 0xff));
			o[14] = unchecked((byte)((int)((uint)x3 >> 16) & 0xff));
			o[15] = unchecked((byte)((int)((uint)x3 >> 24) & 0xff));

			o[16] = unchecked((byte)((int)((uint)x4 >> 0) & 0xff));
			o[17] = unchecked((byte)((int)((uint)x4 >> 8) & 0xff));
			o[18] = unchecked((byte)((int)((uint)x4 >> 16) & 0xff));
			o[19] = unchecked((byte)((int)((uint)x4 >> 24) & 0xff));

			o[20] = unchecked((byte)((int)((uint)x5 >> 0) & 0xff));
			o[21] = unchecked((byte)((int)((uint)x5 >> 8) & 0xff));
			o[22] = unchecked((byte)((int)((uint)x5 >> 16) & 0xff));
			o[23] = unchecked((byte)((int)((uint)x5 >> 24) & 0xff));

			o[24] = unchecked((byte)((int)((uint)x6 >> 0) & 0xff));
			o[25] = unchecked((byte)((int)((uint)x6 >> 8) & 0xff));
			o[26] = unchecked((byte)((int)((uint)x6 >> 16) & 0xff));
			o[27] = unchecked((byte)((int)((uint)x6 >> 24) & 0xff));

			o[28] = unchecked((byte)((int)((uint)x7 >> 0) & 0xff));
			o[29] = unchecked((byte)((int)((uint)x7 >> 8) & 0xff));
			o[30] = unchecked((byte)((int)((uint)x7 >> 16) & 0xff));
			o[31] = unchecked((byte)((int)((uint)x7 >> 24) & 0xff));

			o[32] = unchecked((byte)((int)((uint)x8 >> 0) & 0xff));
			o[33] = unchecked((byte)((int)((uint)x8 >> 8) & 0xff));
			o[34] = unchecked((byte)((int)((uint)x8 >> 16) & 0xff));
			o[35] = unchecked((byte)((int)((uint)x8 >> 24) & 0xff));

			o[36] = unchecked((byte)((int)((uint)x9 >> 0) & 0xff));
			o[37] = unchecked((byte)((int)((uint)x9 >> 8) & 0xff));
			o[38] = unchecked((byte)((int)((uint)x9 >> 16) & 0xff));
			o[39] = unchecked((byte)((int)((uint)x9 >> 24) & 0xff));

			o[40] = unchecked((byte)((int)((uint)x10 >> 0) & 0xff));
			o[41] = unchecked((byte)((int)((uint)x10 >> 8) & 0xff));
			o[42] = unchecked((byte)((int)((uint)x10 >> 16) & 0xff));
			o[43] = unchecked((byte)((int)((uint)x10 >> 24) & 0xff));

			o[44] = unchecked((byte)((int)((uint)x11 >> 0) & 0xff));
			o[45] = unchecked((byte)((int)((uint)x11 >> 8) & 0xff));
			o[46] = unchecked((byte)((int)((uint)x11 >> 16) & 0xff));
			o[47] = unchecked((byte)((int)((uint)x11 >> 24) & 0xff));

			o[48] = unchecked((byte)((int)((uint)x12 >> 0) & 0xff));
			o[49] = unchecked((byte)((int)((uint)x12 >> 8) & 0xff));
			o[50] = unchecked((byte)((int)((uint)x12 >> 16) & 0xff));
			o[51] = unchecked((byte)((int)((uint)x12 >> 24) & 0xff));

			o[52] = unchecked((byte)((int)((uint)x13 >> 0) & 0xff));
			o[53] = unchecked((byte)((int)((uint)x13 >> 8) & 0xff));
			o[54] = unchecked((byte)((int)((uint)x13 >> 16) & 0xff));
			o[55] = unchecked((byte)((int)((uint)x13 >> 24) & 0xff));

			o[56] = unchecked((byte)((int)((uint)x14 >> 0) & 0xff));
			o[57] = unchecked((byte)((int)((uint)x14 >> 8) & 0xff));
			o[58] = unchecked((byte)((int)((uint)x14 >> 16) & 0xff));
			o[59] = unchecked((byte)((int)((uint)x14 >> 24) & 0xff));

			o[60] = unchecked((byte)((int)((uint)x15 >> 0) & 0xff));
			o[61] = unchecked((byte)((int)((uint)x15 >> 8) & 0xff));
			o[62] = unchecked((byte)((int)((uint)x15 >> 16) & 0xff));
			o[63] = unchecked((byte)((int)((uint)x15 >> 24) & 0xff));
	...
	*/
		...
		private static void core_hsalsa20(byte[] o, byte[] p, byte[] k, byte[] c)
		{
			...
			o[4] = unchecked((byte)((int)((uint)x5 >> 0) & 0xff));
			o[5] = unchecked((byte)((int)((uint)x5 >> 8) & 0xff));
			o[6] = unchecked((byte)((int)((uint)x5 >> 16) & 0xff));
			o[7] = unchecked((byte)((int)((uint)x5 >> 24) & 0xff));

			o[8] = unchecked((byte)((int)((uint)x10 >> 0) & 0xff));
			o[9] = unchecked((byte)((int)((uint)x10 >> 8) & 0xff));
			o[10] = unchecked((byte)((int)((uint)x10 >> 16) & 0xff));
			o[11] = unchecked((byte)((int)((uint)x10 >> 24) & 0xff));

			o[12] = unchecked((byte)((int)((uint)x15 >> 0) & 0xff));
			o[13] = unchecked((byte)((int)((uint)x15 >> 8) & 0xff));
			o[14] = unchecked((byte)((int)((uint)x15 >> 16) & 0xff));
			o[15] = unchecked((byte)((int)((uint)x15 >> 24) & 0xff));

			o[16] = unchecked((byte)((int)((uint)x6 >> 0) & 0xff));
			o[17] = unchecked((byte)((int)((uint)x6 >> 8) & 0xff));
			o[18] = unchecked((byte)((int)((uint)x6 >> 16) & 0xff));
			o[19] = unchecked((byte)((int)((uint)x6 >> 24) & 0xff));

			o[20] = unchecked((byte)((int)((uint)x7 >> 0) & 0xff));
			o[21] = unchecked((byte)((int)((uint)x7 >> 8) & 0xff));
			o[22] = unchecked((byte)((int)((uint)x7 >> 16) & 0xff));
			o[23] = unchecked((byte)((int)((uint)x7 >> 24) & 0xff));

			o[24] = unchecked((byte)((int)((uint)x8 >> 0) & 0xff));
			o[25] = unchecked((byte)((int)((uint)x8 >> 8) & 0xff));
			o[26] = unchecked((byte)((int)((uint)x8 >> 16) & 0xff));
			o[27] = unchecked((byte)((int)((uint)x8 >> 24) & 0xff));

			o[28] = unchecked((byte)((int)((uint)x9 >> 0) & 0xff));
			o[29] = unchecked((byte)((int)((uint)x9 >> 8) & 0xff));
			o[30] = unchecked((byte)((int)((uint)x9 >> 16) & 0xff));
			o[31] = unchecked((byte)((int)((uint)x9 >> 24) & 0xff));
	...
	*/
		...
		private static int crypto_stream_salsa20_xor(byte[] c, int cpos, byte[] m, int mpos, long b, byte[] n, byte[] k)
		{
			...
			while (b >= 64)
			{
				...
				for (i = 0; i < 64; i++)
				{
					c[cpos + i] = unchecked((byte)((m[mpos + i] ^ x[i]) & 0xff));
				}
				u = 1;
				for (i = 8; i < 16; i++)
				{
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static int crypto_onetimeauth(byte[] out,final int outpos, byte[] m,final int mpos, int n, byte [] k)
		...
		public static int crypto_onetimeauth(byte[] @out, byte[] m, int n, byte[] k) //long
		{
			return crypto_onetimeauth(@out,0, m,0, n, k);
		}

//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static int crypto_onetimeauth_verify(byte[] h,final int hoff, byte[] m,final int moff, int n, byte [] k)
		private static int crypto_onetimeauth_verify(byte[] h, int hoff, byte[] m, int moff, int n, byte[] k) //long
		{
			byte[] x = new byte[16];
			crypto_onetimeauth(x,0,m,moff,n,k);
			return crypto_verify_16(h,hoff,x,0);
		}
		public static int crypto_onetimeauth_verify(byte[] h, byte[] m, int n, byte[] k) //long
		{
		...
		public static int crypto_secretbox(byte[] c, byte[] m, int d, byte[] n, byte[] k) //long
		{
			int i;
			if (d < 32)
			{
		...
		public static int crypto_secretbox_open(byte[] m, byte[] c, int d, byte[] n, byte[] k) //long
		{
			int i;
			byte[] x = new byte[32];
			if (d < 32)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static void sel25519(long[] p,final int poff, long[] q,final int qoff, int b)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static void pack25519(byte [] o, long [] n,final int noff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static int neq25519(long [] a,final int aoff, long [] b,final int boff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static byte par25519(long [] a,final int aoff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static void A(long [] o,final int ooff, long [] a,final int aoff, long [] b,final int boff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static void Z(long [] o,final int ooff, long [] a,final int aoff, long [] b,final int boff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static void M(long [] o,final int ooff, long [] a,final int aoff, long [] b,final int boff)
		private static void M(long[] o, int ooff, long[] a, int aoff, long[] b, int boff)
		{
			  long v , c , t0 = 0, t1 = 0, t2 = 0, t3 = 0, t4 = 0, t5 = 0, t6 = 0, t7 = 0, t8 = 0, t9 = 0, t10 = 0, t11 = 0, t12 = 0, t13 = 0, t14 = 0, t15 = 0, t16 = 0, t17 = 0, t18 = 0, t19 = 0, t20 = 0, t21 = 0, t22 = 0, t23 = 0, t24 = 0, t25 = 0, t26 = 0, t27 = 0, t28 = 0, t29 = 0, t30 = 0, b0 = b[0 + boff], b1 = b[1 + boff], b2 = b[2 + boff], b3 = b[3 + boff], b4 = b[4 + boff], b5 = b[5 + boff], b6 = b[6 + boff], b7 = b[7 + boff], b8 = b[8 + boff], b9 = b[9 + boff], b10 = b[10 + boff], b11 = b[11 + boff], b12 = b[12 + boff], b13 = b[13 + boff], b14 = b[14 + boff], b15 = b[15 + boff];
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static void S(long [] o,final int ooff, long [] a,final int aoff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static void inv25519(long [] o,final int ooff, long [] i,final int ioff)
		...
		public static int crypto_box_afternm(byte[] c, byte[] m, int d, byte[] n, byte[] k) //long
		{
			return crypto_secretbox(c,m,d,n,k);
		}

		public static int crypto_box_open_afternm(byte[] m, byte[] c, int d, byte[] n, byte[] k) //long
		{
			return crypto_secretbox_open(m,c,d,n,k);
		}

		public static int crypto_box(byte[] c, byte[] m, int d, byte[] n, byte[] y, byte[] x) //long
		{
			byte[] k = new byte[32];
		...
		public static int crypto_box_open(byte[] m, byte[] c, int d, byte[] n, byte[] y, byte[] x) //long
		{
			byte[] k = new byte[32];
			crypto_box_beforenm(k,y,x);
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static int crypto_hashblocks_hl(int [] hh,int [] hl, byte [] m,final int moff, int n)
		private static int crypto_hashblocks_hl(int[] hh, int[] hl, byte[] m, int moff, int n)
		{
			...
			int ah0 = hh[0], ah1 = hh[1], ah2 = hh[2], ah3 = hh[3], ah4 = hh[4], ah5 = hh[5], ah6 = hh[6], ah7 = hh[7], al0 = hl[0], al1 = hl[1], al2 = hl[2], al3 = hl[3], al4 = hl[4], al5 = hl[5], al6 = hl[6], al7 = hl[7];
			...
			while (n >= 128)
			{
				...
				for (i = 0; i < 80; i++)
				{
					...
					// Sigma1
					h = (((int)((uint)ah4 >> 14)) | (al4 << (32 - 14))) ^ (((int)((uint)ah4 >> 18)) | (al4 << (32 - 18))) ^ (((int)((uint)al4 >> (41 - 32))) | (ah4 << (32 - (41 - 32))));
					l = (((int)((uint)al4 >> 14)) | (ah4 << (32 - 14))) ^ (((int)((uint)al4 >> 18)) | (ah4 << (32 - 18))) ^ (((int)((uint)ah4 >> (41 - 32))) | (al4 << (32 - (41 - 32))));
					...
					///h = K[i*2];
					///l = K[i*2+1];
					h = unchecked((int)(((long)((ulong)K[i] >> 32)) & 0xffffffff));
					l = unchecked((int)(((long)((ulong)K[i] >> 0)) & 0xffffffff));
					...
					// Sigma0
					h = (((int)((uint)ah0 >> 28)) | (al0 << (32 - 28))) ^ (((int)((uint)al0 >> (34 - 32))) | (ah0 << (32 - (34 - 32)))) ^ (((int)((uint)al0 >> (39 - 32))) | (ah0 << (32 - (39 - 32))));
					l = (((int)((uint)al0 >> 28)) | (ah0 << (32 - 28))) ^ (((int)((uint)ah0 >> (34 - 32))) | (al0 << (32 - (34 - 32)))) ^ (((int)((uint)ah0 >> (39 - 32))) | (al0 << (32 - (39 - 32))));
					...
					th = wh[(j + 1) % 16];
					tl = wl[(j + 1) % 16];
					h = (((int)((uint)th >> 1)) | (tl << (32 - 1))) ^ (((int)((uint)th >> 8)) | (tl << (32 - 8))) ^ ((int)((uint)th >> 7));
					l = (((int)((uint)tl >> 1)) | (th << (32 - 1))) ^ (((int)((uint)tl >> 8)) | (th << (32 - 8))) ^ (((int)((uint)tl >> 7)) | (th << (32 - 7)));
					...
					th = wh[(j + 14) % 16];
					tl = wl[(j + 14) % 16];
					h = (((int)((uint)th >> 19)) | (tl << (32 - 19))) ^ (((int)((uint)tl >> (61 - 32))) | (th << (32 - (61 - 32)))) ^ ((int)((uint)th >> 6));
					l = (((int)((uint)tl >> 19)) | (th << (32 - 19))) ^ (((int)((uint)th >> (61 - 32))) | (tl << (32 - (61 - 32)))) ^ (((int)((uint)tl >> 6)) | (th << (32 - 6)));
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static int crypto_hash(byte [] out, byte [] m,final int moff, int n)
		public static int crypto_hash(byte[] @out, byte[] m, int moff, int n)
		{
			...
			hh[0] = 0x6a09e667;
			hh[1] = unchecked((int)0xbb67ae85);
			hh[2] = 0x3c6ef372;
			hh[3] = unchecked((int)0xa54ff53a);
			hh[4] = 0x510e527f;
			hh[5] = unchecked((int)0x9b05688c);
			hh[6] = 0x1f83d9ab;
			hh[7] = 0x5be0cd19;

			hl[0] = unchecked((int)0xf3bcc908);
			hl[1] = unchecked((int)0x84caa73b);
			hl[2] = unchecked((int)0xfe94f82b);
			hl[3] = 0x5f1d36f1;
			hl[4] = unchecked((int)0xade682d1);
			hl[5] = 0x2b3e6c1f;
			hl[6] = unchecked((int)0xfb41bd6b);
			hl[7] = 0x137e2179;
		...
		private static void pack(byte[] r, long[][] p)
		{
			...
			r[31] ^= (byte)(par25519(tx,0) << 7);
		}

//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static void scalarmult(long [] p[], long [] q[], byte[] s,final int soff)
		private static void scalarmult(long[][] p, long[][] q, byte[] s, int soff)
		{
			...
			for (i = 255;i >= 0;--i)
			{
				byte b = (byte)(((int)((uint)s[i / 8 + soff] >> (i & 7))) & 1);
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static void scalarbase(long [] p[], byte[] s,final int soff)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: private static void modL(byte[] r,final int roff, long x[])
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static int crypto_sign(byte [] sm, long dummy, byte [] m,final int moff, int n, byte [] sk)
		public static int crypto_sign(byte[] sm, long dummy, byte[] m, int moff, int n, byte[] sk) //long -  *smlen not used
		{
		...
		private static int unpackneg(long[][] r, byte[] p)
		{
			...
			if (par25519(r[0]) == ((int)((uint)(p[31] & 0xFF) >> 7)))
			{
				Z(r[0], gf0, r[0]);
			}
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not allowed in .NET:
//ORIGINAL LINE: public static int crypto_sign_open(byte [] m, long dummy, byte [] sm,final int smoff, int n, byte []pk)
		public static int crypto_sign_open(byte[] m, long dummy, byte[] sm, int smoff, int n, byte[] pk) //long -  *mlen not used
		{
			int i;
...
//ORIGINAL LINE: final StringBuilder hex = new StringBuilder(2 * raw.length);
